...
fn open_badges_fixture_variants_share_the_same_hash() {
  let compact = include_str!("../fixtures/register_source/replay_hashing/open_badges_compact.json");
  let formatted = include_str!("../fixtures/register_source/replay_hashing/open_badges_pretty.json");
...
fn fixture_semantic_changes_produce_different_hashes() {
  ...
  let clr = include_str!("../fixtures/register_source/replay_hashing/clr_compact.json");
  let clr_conflict = include_str!("../fixtures/register_source/replay_hashing/clr_conflict.json");
...
fn normalized_hashing_is_deterministic_across_repeated_runs() {
  let payload = include_str!("../fixtures/register_source/replay_hashing/open_badges_pretty.json");
